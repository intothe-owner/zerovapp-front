        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          ...
          <div className="flex items-center gap-2 mb-6 border-b border-gray-200">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 text-sm font-bold transition-all border-b-2 ${activeTab === "LIST"
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 text-sm font-bold transition-all border-b-2 ${activeTab === "COMPLETE"
